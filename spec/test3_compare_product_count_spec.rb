...
describe "Open_card" do
  ...
  context "Given left bar paragraph in which is count of products" do
    ...
    it "Return actual count of products in this left bar paragraph" do
      ...
      # Application.get.load_header_menu_component.make_menu_subitem_click(COMPONENTS, MONITORS)
      ...
      expect(Application.get.load_header_menu_component.make_menu_subitem_click(COMPONENTS, MONITORS)
          .get_number_of_product_count
          .get_left_bar_product_count(2)).to eql(true)
